...
namespace LogPart.ClassificationService {
    ...
    [System.ServiceModel.ServiceContractAttribute(ConfigurationName="ClassificationService.Service")]
    public interface Service {
        ...
        LogPart.ClassificationService.CompositeType GetDataUsingDataContract(LogPart.ClassificationService.CompositeType composite);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/Service/GetDataUsingDataContract", ReplyAction="http://tempuri.org/Service/GetDataUsingDataContractResponse")]
        System.Threading.Tasks.Task<LogPart.ClassificationService.CompositeType> GetDataUsingDataContractAsync(LogPart.ClassificationService.CompositeType composite);
        ...
        LogPart.ClassificationService.DiscoverSchemaResponse DiscoverSchema(LogPart.ClassificationService.DiscoverSchemaRequest request);
        
        // CODEGEN: Generating message contract since the operation has multiple return values.
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/Service/DiscoverSchema", ReplyAction="http://tempuri.org/Service/DiscoverSchemaResponse")]
        System.Threading.Tasks.Task<LogPart.ClassificationService.DiscoverSchemaResponse> DiscoverSchemaAsync(LogPart.ClassificationService.DiscoverSchemaRequest request);
        ...
        void TrainSystem(string DirName, string Cluster, string user);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/Service/TrainSystem", ReplyAction="http://tempuri.org/Service/TrainSystemResponse")]
        System.Threading.Tasks.Task TrainSystemAsync(string DirName, string Cluster, string user);
    ...
    public partial class DiscoverSchemaRequest {
        ...
        public LogPart.ClassificationService.InnerData UserInnerData;
        
        public DiscoverSchemaRequest() {
        }
        
        public DiscoverSchemaRequest(string FileName, string user, LogPart.ClassificationService.InnerData UserInnerData) {
    ...
    public partial class DiscoverSchemaResponse {
        ...
        public DiscoverSchemaResponse(string DiscoverSchemaResult, LogPart.ClassificationService.InnerData UserInnerData) {
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface ServiceChannel : LogPart.ClassificationService.Service, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class ServiceClient : System.ServiceModel.ClientBase<LogPart.ClassificationService.Service>, LogPart.ClassificationService.Service {
        ...
        public LogPart.ClassificationService.CompositeType GetDataUsingDataContract(LogPart.ClassificationService.CompositeType composite) {
            return base.Channel.GetDataUsingDataContract(composite);
        }
        
        public System.Threading.Tasks.Task<LogPart.ClassificationService.CompositeType> GetDataUsingDataContractAsync(LogPart.ClassificationService.CompositeType composite) {
        ...
        LogPart.ClassificationService.DiscoverSchemaResponse LogPart.ClassificationService.Service.DiscoverSchema(LogPart.ClassificationService.DiscoverSchemaRequest request) {
            return base.Channel.DiscoverSchema(request);
        }
        
        public string DiscoverSchema(string FileName, string user, ref LogPart.ClassificationService.InnerData UserInnerData) {
            LogPart.ClassificationService.DiscoverSchemaRequest inValue = new LogPart.ClassificationService.DiscoverSchemaRequest();
            inValue.FileName = FileName;
            inValue.user = user;
            inValue.UserInnerData = UserInnerData;
            LogPart.ClassificationService.DiscoverSchemaResponse retVal = ((LogPart.ClassificationService.Service)(this)).DiscoverSchema(inValue);
            UserInnerData = retVal.UserInnerData;
            return retVal.DiscoverSchemaResult;
        }
        
        public System.Threading.Tasks.Task<LogPart.ClassificationService.DiscoverSchemaResponse> DiscoverSchemaAsync(LogPart.ClassificationService.DiscoverSchemaRequest request) {
            return base.Channel.DiscoverSchemaAsync(request);
        }
        
        public void TrainSystem(string DirName, string Cluster, string user) {
            base.Channel.TrainSystem(DirName, Cluster, user);
        }
        
        public System.Threading.Tasks.Task TrainSystemAsync(string DirName, string Cluster, string user) {
